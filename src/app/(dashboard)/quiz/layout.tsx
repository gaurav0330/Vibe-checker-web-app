...
export default function QuizLayout({
  ...
  return (
    <div className=" pb-16 md:pb-0 min-h-screen bg-gradient-to-br from-[#0e0b1f] to-[#130f3f] text-white">
      {/* Mobile Header */}
      <MobileHeader />
      ...
      {/* Main Content */}
      <main className="container mx-auto p-4 md:p-8 min-h-screen bg-gradient-to-br from-[#0e0b1f] to-[#130f3f] text-white">
        {children}
      </main>
